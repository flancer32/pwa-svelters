...
/** @type {Svelters_Back_Store_RDb_Schema_Weight_Goal} */
const schema = await container.get('Svelters_Back_Store_RDb_Schema_Weight_Goal$');

describe('Svelters_Back_Store_RDb_Schema_Weight_Goal', () => {
    ...
    it('should have the correct ENTITY name and primary key', () => {
        assert.equal(schema.getEntityName(), `${DEF.NAME}/app/weight/goal`, 'Entity name should match the expected path');
