...
/** @type {Svelters_Back_Store_RDb_Schema_User_Delete} */
const schema = await container.get('Svelters_Back_Store_RDb_Schema_User_Delete$');

describe('Svelters_Back_Store_RDb_Schema_User_Delete', () => {
    ...
    it('should have the correct ENTITY name and primary key', () => {
        assert.equal(schema.getEntityName(), `${DEF.NAME}/app/user/delete`, 'Entity name should match the expected path');
