...
/** @type {Svelters_Back_Store_RDb_Schema_Calorie_Log_Draft} */
const schema = await container.get('Svelters_Back_Store_RDb_Schema_Calorie_Log_Draft$');

describe('Svelters_Back_Store_RDb_Schema_Calorie_Log_Draft', () => {
    ...
    it('should have the correct ENTITY name and primary key', () => {
        assert.equal(schema.getEntityName(), `${DEF.NAME}/app/calorie/log/draft`, 'Entity name should match the expected path');
