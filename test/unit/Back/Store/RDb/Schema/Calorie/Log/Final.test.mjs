...
/** @type {Svelters_Back_Store_RDb_Schema_Calorie_Log_Final} */
const schema = await container.get('Svelters_Back_Store_RDb_Schema_Calorie_Log_Final$');

describe('Svelters_Back_Store_RDb_Schema_Calorie_Log_Final', () => {
    ...
    it('should have the correct ENTITY name and primary key', () => {
        assert.equal(schema.getEntityName(), `${DEF.NAME}/app/calorie/log/final`, 'Entity name should match the expected path');
