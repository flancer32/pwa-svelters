...
/** @type {Svelters_Back_Store_RDb_Schema_Feedback_Inbox} */
const schema = await container.get('Svelters_Back_Store_RDb_Schema_Feedback_Inbox$');

describe('Svelters_Back_Store_RDb_Schema_Feedback_Inbox', () => {
    ...
    it('should have the correct ENTITY name and primary key', () => {
        assert.equal(schema.getEntityName(), `${DEF.NAME}/app/feedback/inbox`, 'Entity name should match the expected path');
