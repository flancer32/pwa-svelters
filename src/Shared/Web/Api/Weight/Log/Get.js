/**
 * API Endpoint: Retrieve user's weight measurement history.
 *
 * Accepts a date range and returns a list of weight log entries
 * within that period, along with processing metadata.
 *
 * @implements Svelters_Shared_Api_Endpoint
 */
export default class Svelters_Shared_Web_Api_Weight_Log_Get {
    /**
     ...
     * @param {Svelters_Shared_Dto_Weight} dtoItem - Factory for individual weight log items.
     */
    constructor(
        {
         ...
         *
         * @param {Svelters_Shared_Web_Api_Weight_Log_Get.Request} [data]
         * @return {Svelters_Shared_Web_Api_Weight_Log_Get.Request}
         */
         ...
         *
         * @param {Svelters_Shared_Web_Api_Weight_Log_Get.Response} [data]
         * @returns {Svelters_Shared_Web_Api_Weight_Log_Get.Response}
         */
         ...
         *
         * @returns {typeof Svelters_Shared_Web_Api_Weight_Log_Get.ResultCode}
         */
...
/**
 * @memberOf Svelters_Shared_Web_Api_Weight_Log_Get
 */
class Request {
    /**
...
class Response {
    /**
     * List of weight log entries for the given date range.
...
const ResultCode = {
    /**
     * Weight log entries were successfully retrieved.
     */
    SUCCESS: 'SUCCESS',
