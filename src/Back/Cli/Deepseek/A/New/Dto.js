/**
 * A class for generating new TeqFW-compliant DTOs via Deepseek as part of CLI command.
 */
export default class Svelters_Back_Cli_Deepseek_A_New_Dto {
    /**
    ...
    constructor(
        ...
        this.run = async function (rootWork, rootDocs) {
            const pathDocs = join(rootDocs, 'new', 'dto');
            const pathWork = join(rootWork, 'new', 'dto');
            const [
                prompt,
                docSample,
            ...
            // a user message to generate new DTO module
            const msg = {
                role: 'user',
                content: `
## The samples:
...
`
            ...
            logger.info(`Generate a new DTO.`);
