 ...
 *
 * @namespace Svelters_Back_Act_WebAuthn_Challenge_Attest
 */
// MODULE'S VARS
const NS = 'Svelters_Back_Act_WebAuthn_Challenge_Attest';
...
export default function (spec) {
     ...
     * @memberOf Svelters_Back_Act_WebAuthn_Challenge_Attest
     */
