/**
 * Repository for managing Calorie Log Final Items in the database.
 * @implements TeqFw_Db_Back_Api_RDb_Repository
 */
export default class Svelters_Back_Store_RDb_Repo_Calorie_Log_Final_Item {
    /**
     * @param {TeqFw_Db_Back_App_Crud} crud - CRUD engine for database operations.
     * @param {Svelters_Back_Store_RDb_Schema_Calorie_Log_Final_Item} schema - Persistent DTO schema for Calorie Log Final Item.
     */
    constructor(
        {
            TeqFw_Db_Back_App_Crud$: crud,
            Svelters_Back_Store_RDb_Schema_Calorie_Log_Final_Item$: schema,
        }
    ) {
        /**
         * Creates a DTO with type validation.
         *
         * @param {Svelters_Back_Store_RDb_Schema_Calorie_Log_Final_Item.Dto} [dto]
         ...
         * @param {Svelters_Back_Store_RDb_Schema_Calorie_Log_Final_Item.Dto} [params.dto]
         ...
         *
         * @returns {Svelters_Back_Store_RDb_Schema_Calorie_Log_Final_Item}
         */
         ...
         * @returns {Promise<{records: Array<Svelters_Back_Store_RDb_Schema_Calorie_Log_Final_Item.Dto>}>}
         */
         ...
         * @returns {Promise<{record: Svelters_Back_Store_RDb_Schema_Calorie_Log_Final_Item.Dto|null}>}
         */
