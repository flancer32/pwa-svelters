 ...
 */
export default class Svelters_Back_Store_RDb_Repo_User_Profile {
    /**
     * @param {TeqFw_Db_Back_App_Crud} crud - CRUD engine for database operations.
     * @param {Svelters_Back_Store_RDb_Schema_User_Profile} schema - Persistent DTO schema for User Profile.
     */
    constructor(
        {
            TeqFw_Db_Back_App_Crud$: crud,
            Svelters_Back_Store_RDb_Schema_User_Profile$: schema,
        }
    ) {
        /**
         * @returns {Svelters_Back_Store_RDb_Schema_User_Profile}
         */
        this.getSchema = () => schema;

        /**
         * @param {Svelters_Back_Store_RDb_Schema_User_Profile.Dto} [dto]
         ...
         * @param {Svelters_Back_Store_RDb_Schema_User_Profile.Dto} [params.dto]
         ...
         * @returns {Promise<{record: Svelters_Back_Store_RDb_Schema_User_Profile.Dto|null}>}
         */
