/**
 * Repository for managing User Delete records in the database.
 * @implements TeqFw_Db_Back_Api_RDb_Repository
 */
export default class Svelters_Back_Store_RDb_Repo_User_Delete {
    /**
     * @param {TeqFw_Db_Back_App_Crud} crud - CRUD engine for database operations.
     * @param {Svelters_Back_Store_RDb_Schema_User_Delete} schema - Persistent DTO schema for User Delete.
     */
    constructor(
        {
            TeqFw_Db_Back_App_Crud$: crud,
            Svelters_Back_Store_RDb_Schema_User_Delete$: schema,
        }
    ) {
        /**
         * @param {Svelters_Back_Store_RDb_Schema_User_Delete.Dto} [dto]
         ...
         * @param {Svelters_Back_Store_RDb_Schema_User_Delete.Dto} [params.dto]
        ...
        /**
         * @returns {Svelters_Back_Store_RDb_Schema_User_Delete}
         */
         ...
         * @returns {Promise<{records: Array<Svelters_Back_Store_RDb_Schema_User_Delete.Dto>}>}
         */
         ...
         * @returns {Promise<{record: Svelters_Back_Store_RDb_Schema_User_Delete.Dto|null}>}
         */
