/**
 * Repository for managing Weight Goals in the database.
 * @implements TeqFw_Db_Back_Api_RDb_Repository
 */
export default class Svelters_Back_Store_RDb_Repo_Weight_Goal {
    /**
     * @param {TeqFw_Db_Back_App_Crud} crud - CRUD engine for database operations.
     * @param {Svelters_Back_Store_RDb_Schema_Weight_Goal} schema - Persistent DTO schema for Weight Goal.
     */
    constructor(
        {
            TeqFw_Db_Back_App_Crud$: crud,
            Svelters_Back_Store_RDb_Schema_Weight_Goal$: schema,
        }
    ) {
        /**
         * @param {Svelters_Back_Store_RDb_Schema_Weight_Goal.Dto} [dto]
        ...
        /**
         * @returns {Svelters_Back_Store_RDb_Schema_Weight_Goal}
         */
